  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 id="delete-folder-title" className="mt-5 text-xl font-semibold tracking-[-0.025em]">
          폴더를 삭제할까요?
        </h2>
        <p id="delete-folder-description" className="mt-2 text-sm leading-6 text-[var(--text-sub)]">
          <strong className="font-semibold text-[var(--text)]">{folder.name}</strong> 폴더가 사이드바에서 삭제됩니다.
          이 작업은 되돌릴 수 없습니다.
        </p>
