...
export default function Sidebar({ folders, activeFolderId, total, onDeleteFolder, onRenameFolder }: Props) {
  ...
  return (
    <aside className="border-b border-[var(--border)] bg-[var(--sidebar)] px-3 py-3 lg:flex lg:min-h-[calc(100vh-48px)] lg:w-[240px] lg:shrink-0 lg:flex-col lg:border-b-0 lg:border-r lg:px-2.5 lg:py-4">
      ...
      <div className="mt-auto border-t border-[var(--border)] px-2.5 pt-4 lg:mt-8">
      ...
      <form action={signOut} className="mt-3">
        <button type="submit" className="utility-button focus-ring flex w-full items-center gap-2 rounded-md px-2.5 py-1.5 text-sm text-[var(--text-sub)]">
